...
class PokemonRepositoryImplTest {
    ...
    private val emptyDamageRelations =
        DamageRelations(
    ...
    @Test
    fun `getPokemonList returns pokemon with correct ids and names`() =
        runTest {
            coEvery { api.getPokemonList(limit = 1) } returns
                PokemonListResponse(
                    count = 2,
                    results = listOf(PokemonDto("bulbasaur", "https://pokeapi.co/api/v2/pokemon-species/1/")),
                )
            coEvery { api.getPokemonList(limit = 2) } returns
                PokemonListResponse(
                    count = 2,
                    results =
                        listOf(
    ...
    @Test
    fun `getPokemonList builds correct sprite urls`() =
        runTest {
            coEvery { api.getPokemonList(limit = 1) } returns
                PokemonListResponse(
                    count = 1,
            ...
            coEvery { api.getPokemonList(limit = 1, offset = 0) } returns
                PokemonListResponse(
                    count = 1,
                    results = listOf(PokemonDto("pikachu", "https://pokeapi.co/api/v2/pokemon-species/25/")),
                )
    ...
    @Test
    fun `getPokemonList populates types from type map`() =
        runTest {
            coEvery { api.getPokemonList(limit = 1) } returns
                PokemonListResponse(
                    count = 1,
            ...
            coEvery { api.getTypeList(any()) } returns
                PokemonListResponse(
                    count = 2,
                    results =
                        listOf(
            ...
            coEvery { api.getType("grass") } returns
                TypeResponse(
                    name = "grass",
            ...
            coEvery { api.getType("poison") } returns
                TypeResponse(
                    name = "poison",
                    damageRelations = emptyDamageRelations,
                    pokemon =
    ...
    @Test
    fun `getPokemonList returns empty types when type map has no match`() =
        runTest {
            coEvery { api.getPokemonList(limit = 1) } returns
                PokemonListResponse(
                    count = 1,
    ...
    @Test
    fun `getPokemonDetail maps fields correctly`() =
        runTest {
    ...
    @Test
    fun `getPokemonDetail maps types with damage relations`() =
        runTest {
            stubDetailAndSpecies()
    ...
    @Test
    fun `getPokemonDetail maps abilities correctly`() =
        runTest {
            stubDetailAndSpecies()
    ...
    @Test
    fun `getPokemonDetail maps cryUrl from latest`() =
        runTest {
            stubDetailAndSpecies()
    ...
    @Test
    fun `getPokemonDetail falls back to legacy cry when latest is null`() =
        runTest {
            stubDetailAndSpecies(
    ...
    @Test
    fun `getPokemonDetail cryUrl is null when cries is null`() =
        runTest {
    ...
    @Test
    fun `getPokemonDetail maps moves sorted by level then name`() =
        runTest {
            stubDetailAndSpecies(
                moves =
                    listOf(
    ...
    @Test
    fun `getPokemonDetail skips non-level-up moves`() =
        runTest {
            stubDetailAndSpecies(
                moves =
                    listOf(
    ...
    @Test
    fun `getPokemonDetail falls back to front_default sprite`() =
        runTest {
            stubDetailAndSpecies(
    ...
    @Test
    fun `getPokemonDetail returns empty imageUrl when no sprites`() =
        runTest {
            stubDetailAndSpecies(
    ...
    @Test
    fun `getPokemonDetail maps all generation regions`() =
        runTest {
            val generationMap =
                mapOf(
    ...
    @Test
    fun `getPokemonDetail returns empty description when no english entry`() =
        runTest {
            stubDetailAndSpecies(
                flavorTextEntries =
                    listOf(
    ...
    @Test
    fun `getEvolutionInfo returns evolution chain`() =
        runTest {
            ...
            coEvery { api.getPokemonSpecies(1) } returns
            ...
            coEvery { api.getEvolutionChain(1) } returns
    ...
    @Test
    fun `getEvolutionInfo returns varieties`() =
        runTest {
            coEvery { api.getPokemonSpecies(6) } returns
                PokemonSpeciesResponse(
                    flavorTextEntries = emptyList(),
                    generation = NamedApiResource("generation-i", ""),
                    evolutionChain = null,
    ...
    @Test
    fun `getEvolutionInfo returns empty evolutions when no chain`() =
        runTest {
            coEvery { api.getPokemonSpecies(1) } returns
                PokemonSpeciesResponse(
                    flavorTextEntries = emptyList(),
    ...
    @Test
    fun `getEvolutionInfo formats trade trigger`() =
        runTest {
            stubEvolutionSpecies(67, "Machoke")
            stubEvolutionSpecies(68, "Machamp")
            coEvery { api.getPokemonSpecies(66) } returns
                PokemonSpeciesResponse(
                    flavorTextEntries = emptyList(),
                    generation = NamedApiResource("generation-i", ""),
                    ...
                    varieties =
                        listOf(
                            PokemonVarietyEntry(
                                true,
                                NamedApiResource("machop", "https://pokeapi.co/api/v2/pokemon/66/"),
                            ),
                        ),
                    names = listOf(LocalizedName("Machop", NamedApiResource("en", ""))),
                )
            coEvery { api.getEvolutionChain(33) } returns
                EvolutionChainResponse(
                    chain =
                        ChainLink(
                                ...
                                listOf(
                                    ChainLink(
                                        species =
                                            NamedApiResource(
                                                "machoke",
                                                "https://pokeapi.co/api/v2/pokemon-species/67/",
                                            ),
                                        evolvesTo =
                                            listOf(
                                                ChainLink(
                                                    species =
                                                        NamedApiResource(
                                                            "machamp",
                                                            "https://pokeapi.co/api/v2/pokemon-species/68/",
                                                        ),
                                                    evolvesTo = emptyList(),
                                                    evolutionDetails =
                                                        listOf(
    ...
    @Test
    fun `getEvolutionInfo formats use-item trigger`() =
        runTest {
            stubEvolutionSpecies(134, "Vaporeon")
            coEvery { api.getPokemonSpecies(133) } returns
                PokemonSpeciesResponse(
                    flavorTextEntries = emptyList(),
                    generation = NamedApiResource("generation-i", ""),
                    ...
                    varieties =
                        listOf(
                            PokemonVarietyEntry(
                                true,
                                NamedApiResource("eevee", "https://pokeapi.co/api/v2/pokemon/133/"),
                            ),
                        ),
                    names = listOf(LocalizedName("Eevee", NamedApiResource("en", ""))),
                )
            coEvery { api.getEvolutionChain(67) } returns
                EvolutionChainResponse(
                    chain =
                        ChainLink(
    ...
    @Test
    fun `getEvolutionInfo formats level-up without min level`() =
        runTest {
                                ...
                                listOf(
                                    ChainLink(
                                        species =
                                            NamedApiResource(
                                                "espeon",
                                                "https://pokeapi.co/api/v2/pokemon-species/196/",
                                            ),
                                        evolvesTo = emptyList(),
                                        evolutionDetails =
                                            listOf(
    ...
    @Test
    fun `getPokemonDetail maps stats correctly`() =
        runTest {
            stubDetailAndSpecies(
                stats =
                    listOf(
            ...
            coEvery { api.getStat("hp") } returns
                StatResponse(
                    "hp",
                    names = listOf(LocalizedName("HP", NamedApiResource("en", ""))),
                )
            coEvery { api.getStat("attack") } returns
                StatResponse(
                    "attack",
                    names = listOf(LocalizedName("Attack", NamedApiResource("en", ""))),
                )
            coEvery { api.getStat("special-attack") } returns
                StatResponse(
                    "special-attack",
    ...
    @Test
    fun `getPokemonDetail returns cached data when available`() =
        runTest {
            val cachedJson =
                """{"id":25,"name":"Pikachu","imageUrl":"https://example.com/25.png",""" +
                    """"description":"Cached.","region":"Kanto","types":[],"abilities":[]}"""
    ...
    @Test
    fun `getPokemonList returns cached data when available`() =
        runTest {
            coEvery { dao.getAllPokemon() } returns
                listOf(
                    PokemonEntity(
                        id = 1,
                        name = "Bulbasaur",
    ...
    @Test
    fun `getPokemonList with forceRefresh skips cache`() =
        runTest {
            coEvery { dao.getAllPokemon() } returns
                listOf(
                    PokemonEntity(
    ...
    @Test
    fun `getPokemonList re-fetches when cached pokemon have empty types`() =
        runTest {
            coEvery { dao.getAllPokemon() } returns
                listOf(
                    PokemonEntity(
    ...
    @Test
    fun `getPokemonList re-fetches when cached types are not English`() =
        runTest {
    ...
    @Test
    fun `getEvolutionInfo returns cached data when available`() =
        runTest {
            val cachedJson =
                """{"evolutions":[],"varieties":[{"id":1,"name":"Bulbasaur",""" +
                    """"imageUrl":"https://example.com/1.png","isDefault":true}]}"""
    ...
    @Test
    fun `toggleFavorite insertsWhenNotCurrentlyFavorite`() =
        runTest {
    ...
    @Test
    fun `toggleFavorite deletesWhenCurrentlyFavorite`() =
        runTest {
    ...
    @Test
    fun `getFavoriteIds mapsListToSet`() =
        runTest {
    ...
    @Test
    fun `getFavoriteIds emptyListMapsToEmptySet`() =
        runTest {
    ...
    private fun stubEvolutionSpecies(
        id: Int,
        englishName: String,
    ) {
    ...
    private fun stubDetailAndSpecies(
        ...
        coEvery { api.getPokemonDetail(25) } returns
        ...
        coEvery { api.getPokemonSpecies(25) } returns
            PokemonSpeciesResponse(
        ...
        coEvery { api.getType("electric") } returns
            TypeResponse(
                name = "electric",
                damageRelations =
                    DamageRelations(
        ...
        coEvery { api.getAbility("static") } returns
            AbilityResponse(
                "static",
                names = listOf(LocalizedName("Static", NamedApiResource("en", ""))),
            )
        coEvery { api.getAbility("lightning-rod") } returns
            AbilityResponse(
                "lightning-rod",
        ...
        for (stat in stats) {
            coEvery { api.getStat(stat.stat.name) } returns
                StatResponse(
                    stat.stat.name,
                    names =
                        listOf(
